...
For PointMassNavigate-v0 and PushT-v0, both of which are implemented entirely in PyTorch, APG differentiability is achieved without any special gradient bridge.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}llll@{}}
    ...
    Action dim             & 2                         & 3                          & 7 \\
    Dynamics               & Point mass (Euler)        & 2D rigid body (Euler)      & Articulated body (FK) \\
...
Figure~\ref{fig:return_curves} shows the episodic return curves (mean $\pm$ std over 5 seeds) for all three environments, plotted against total gradient steps to enable a fair compute-controlled comparison between PPO and APG. Table~\ref{tab:final_return} summarises the final returns.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{../figures/return_curves}
  \caption{Episodic return (mean $\pm$ std, 5 seeds) vs.\ total gradient steps for PPO (blue) and APG (orange) across three environments. The x-axis is equalized: both algorithms execute the same total number of gradient updates.}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}lcc@{}}
    ...
    \midrule
    PointMassNavigate-v0 & $-64.89 \pm 11.92$ & $-5.25 \pm 3.36$ \\
    PushT-v0             & $-2.47 \pm 4.69$   & $-0.64 \pm 0.28$ \\
    FrankaReach-v0       & $0.02 \pm 0.25$    & $0.92 \pm 0.33$ \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}clccc@{}}
    ...
    \midrule
    Full episode & ---    & $-5.25 \pm 3.36$ & $-0.64 \pm 0.28$ & N/A \\
    10           & MC     & $-4.23 \pm 1.80$ & $-0.25 \pm 0.50$ & N/A \\
    10           & Critic & $-4.23 \pm 1.80$ & $-0.25 \pm 0.50$ & N/A \\
    5            & MC     & $-4.08 \pm 0.60$ & $-0.41 \pm 0.05$ & N/A \\
    5            & Critic & $-4.08 \pm 0.60$ & $-0.41 \pm 0.05$ & N/A \\
    \bottomrule
  \end{tabular}
\end{table}
...
See Figure~\ref{fig:return_curves} in Section~\ref{sec:results} for the return curves (mean $\pm$ std, 5 seeds) plotted against total gradient steps.
