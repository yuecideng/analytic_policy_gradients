...
if __name__ == "__main__":
    ...
    if args.algorithm == "ppo":
        ...
        raise NotImplementedError(
            "APG mode requires a differentiable torch environment. "
            "Replace the env setup in the '__main__' block with your env. "
            "The env must return torch tensors with gradients preserved. See TorchSyncVecEnv "
